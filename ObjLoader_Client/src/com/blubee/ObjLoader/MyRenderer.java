...
import symlab.ust.hk.database.manager.DatabaseCommons;
...
public class MyRenderer implements GLSurfaceView.Renderer  {
	...
	//private Logger Log = Logger.getLogger(MyRenderer.class.getName());
	...
	public MyRenderer(Context context)
	{
		...
		dataEvent.getInstance().getDatabaseManager().saveData("Begin creation of segment " + ObjDescriptor.counter, System.currentTimeMillis() - MainActivity.lineTime);
		myObj.addObjSegment();	
		dataEvent.getInstance().getDatabaseManager().saveData("Finish creation of segment " + ObjDescriptor.counter, System.currentTimeMillis() - MainActivity.lineTime);
	...
	public void onDrawFrame(GL10 gl) {
		...
		if (Util.touchTurn != 0) { 
	    	...
	    	//Log.info("Angle: " + Util.rotationalX);
        	Util.touchTurn = 0;
        }
